...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirme seu e-mail — Jovem do Vinho',
  invite: 'Você foi convidado — Jovem do Vinho',
  magiclink: 'Seu link de acesso — Jovem do Vinho',
  recovery: 'Redefinir sua senha — Jovem do Vinho',
  email_change: 'Confirme a alteração de e-mail — Jovem do Vinho',
  reauthentication: 'Seu código de verificação — Jovem do Vinho',
}
...
// Configuration
const SITE_NAME = "vinho-guia-magico"
const SENDER_DOMAIN = "notify.jovemdovinho.com.br"
const ROOT_DOMAIN = "jovemdovinho.com.br"
const FROM_DOMAIN = "jovemdovinho.com.br" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://vinho-guia-magico.lovable.app"
