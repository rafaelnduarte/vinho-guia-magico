CREATE OR REPLACE FUNCTION public.list_members_paginated(_page integer DEFAULT 1, _page_size integer DEFAULT 50, _search text DEFAULT ''::text, _status text DEFAULT ''::text, _membership_type text DEFAULT ''::text, _role text DEFAULT ''::text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
